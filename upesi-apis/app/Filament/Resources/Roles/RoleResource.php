...
class RoleResource extends Resource
{
    ...
    // Remplace ou ajoute cette méthode dans RoleResource.php

    public static function getNavigationGroup(): ?string
    {
        return 'Comptes & Permissions';
    }
        ...
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('description')->label('Description')
                    ->limit(50) // Affiche les 50 premiers caractères
                    ->tooltip(fn($record): string => $record->description ?? ''), // Affiche le texte complet au survol,
