...
class PriceHistoryResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Hstorique des prix';

    protected static ?string $modelLabel = 'Hstorique des prix';

    protected static ?string $pluralModelLabel = 'Hstorique des prix';
